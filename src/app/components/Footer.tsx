...
const Footer = () => {
  return (
    <div>
      <footer className="text-white body-font font-semibold bg-fixed bg-cover bg-center custom-image">
        ...
        <span className="ml-3 text-xl mb-1">Hasnain Raza</span>
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start space-x-4 ">
            ...
            <Link 
            target="_blank" 
            href={"https://github.com/hasnainraza321"} className="text-white hover:text-gray-600 text-xl">
